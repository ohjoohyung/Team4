...
public class RoutineBrdController {
	...
	public String routineBrdInsert(Model model, HttpServletRequest request)
	...
	public String routineBrdInsert(RoutineBrdDto routinebrddto, HttpServletRequest request)
	...
	public String routineBrdEdit(int routine_brd_seq, Model model, HttpServletRequest request)
			throws ClassNotFoundException, SQLException {
		RoutineBrdDto routinebrddto = routinebrdservice.routineBrdDetail(routine_brd_seq);
		UserDto user = (UserDto) request.getSession().getAttribute("currentUser");
		String user_email = user.getUser_email();
	...
	public String routineBrdEdit(RoutineBrdDto routinebrddto, HttpServletRequest request)
			throws IOException, ClassNotFoundException, SQLException {
