...
//state: 애플리케이션이 생성한 상태 토큰
	...
	*/
	private final static String CLIENT_ID = "MV0TDNEojieAtJrJfsza";
	private final static String CLIENT_SECRET = "uiOX87QyZd";
	private final static String REDIRECT_URI = "http://localhost:8090/tst/callback";
	private final static String SESSION_STATE = "oauth_state";
