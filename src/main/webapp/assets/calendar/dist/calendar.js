...
!(function (t, e) {
    ...
    function n(e, a) {
        (this.$element = t(e)),
            (this.options = t.extend({}, t.fn.calendar.defaults, a)),
    ...
    var s = {
        ...
        p = "disabled",
        m = "markData",
        f = { date: "calendar-d", month: "calendar-m" },
        g = "old",
        v = "new",
        D = "now",
        w = "selected",
    ...
    (String.prototype.repeat = function (t) {
        ...
        (Date.getSiblingsMonth = function (t, e, a) {
            ...
            return i.setMonth(e - 1 + a), { y: i.getFullYear(), m: i.getMonth() + 1 };
        }),
        ...
        (n.prototype = {
            ...
            getDayItem: function (e, a, i, n) {
                var s,
                    ...
                    r = this.date,
                    h = new Date(e, a - 1, i),
                    l = { w: this.width / 7, h: this.height / 7, value: i };
                r.isSame(e, a, i) ? w : "";
                return (
                    1 === n ? (l.class = g) : 3 === n ? (l.class = v) : (l.class = ""),
                    r.isSame(e, a, i) && (l.class += " " + D),
                    (l.date = h.format(this.options.format)),
                    (l.action = this.getDayAction(h)),
                    (s = this.getDayData(h)),
                    (o = t(b.repeat(l))),
                    s && (o.data(m, s), o.html(i + y)),
                    o
                );
            },
            getDaysHtml: function (a, i) {
                var n,
                    ...
                    h,
                    l,
                    d = (this.date, t('<ol class="days"></ol>'));
                e(a) ? ((n = a.getFullYear()), (s = a.getMonth() + 1)) : ((n = Number(a)), (s = Number(i))),
                    (o = new Date(n, s - 1, 1).getDay() || 7),
                    (l = o - this.options.startWeek),
                    (r = Date.getDaysNum(n, s)),
                    (h = Date.getPrevMonth(n, s)),
                    (prevDaysNum = Date.getDaysNum(n, h.m)),
                    (nextM = Date.getNextMonth(n, s));
            ...
            getWeekHtml: function () {
                for (var t = [], e = this.options.weekArray, a = this.options.startWeek, i = e.length, n = this.width / 7, s = this.height / 7, o = a; o < i; o++) t.push(x.repeat({ w: n, h: s, wk: e[o] }));
                for (var r = 0; r < a; r++) t.push(x.repeat({ w: n, h: s, wk: e[r] }));
                return t.join("");
            },
            getMonthHtml: function () {
                for (var t = this.options.monthArray, e = [], a = this.width / 4, i = this.height / 4, n = 0; n < 12; n++) e.push(I.repeat({ w: a, h: i, m: t[n] }));
                return e.join("");
            },
            setMonthAction: function (t) {
                var e = this.date.getMonth() + 1;
                this.$monthItems.children().removeClass(D),
            ...
            fillStatic: function () {
                var t = { prev: this.options.prev, next: this.options.next, week: this.getWeekHtml(), month: this.getMonthHtml() };
                this.$element.html(k.join("").repeat(t));
            },
            updateDisDate: function (t, e) {
                this.$disDate.html(M.repeat({ year: t, month: e }));
            },
            updateDisMonth: function (t) {
                this.$disMonth.html(t);
            },
            fillDateItems: function (t, e) {
                var a = [Date.getPrevMonth(t, e), { y: t, m: e }, Date.getNextMonth(t, e)];
                this.$dateItems.html("");
                for (var i = 0; i < 3; i++) {
            ...
            setPosition: function () {
                ...
                this.$element.css({ left: t.left + e[0] + "px", top: t.top + this.$trigger.outerHeight() + e[1] + "px" });
            },
            trigger: function () {
                this.$trigger = t(this.options.trigger);
                var e = this,
                    a = e.$element;
                a.addClass("calendar-modal").css("zIndex", e.options.zIndex),
                    t(document)
                        .click(function (i) {
            ...
            render: function () {
                (this.$week = this.$element.find(".week")),
                    ...
                    (this.$disDate = this.$element.find(r)),
                    (this.$disMonth = this.$element.find(h));
                ...
                var s = this,
                    ...
                    r = {
                        prev: function () {
                            ...
                            (a = i.m),
                                (e = i.y),
                                o.animate({ marginLeft: 0 }, 300, "swing", function () {
                        ...
                        next: function () {
                            ...
                            (a = i.m),
                                (e = i.y),
                                o.animate({ marginLeft: "-200%" }, 300, "swing", function () {
                                    o.children(":first").remove(), o.append(h).css("margin-left", "-100%"), t.isFunction(n) && n.call(s);
                                });
                        },
                    };
                return i ? r[i]() : this.fillDateItems(e, a), this.updateDisDate(e, a), this.setView("date"), { y: e, m: a };
            },
            ...
            selectedDay: function (t, e) {
                ...
                if (e) {
                    var o = this.updateDateView(i, n, { old: "prev", new: "next" }[e], s);
            ...
            showLabel: function (t, e, a, i) {
                var n = this.$label;
                n.find("p").html(this.options.label.repeat({ m: e, d: a.format(this.options.format), v: i }).replace(/\n/g, "<br>"));
                var s = n.outerWidth(),
                    o = n.outerHeight();
                n.css({ left: t.pageX - s / 2 + "px", top: t.pageY - o - 20 + "px", zIndex: this.options.zIndex + 1 }).show();
            },
            hasLabel: function () {
            ...
            resize: function () {
                ...
                this.$element
                    ...
                    .css("width", t + "px"),
                    this.$element.find(".calendar-ct").width(t).height(e);
            },
            init: function () {
        ...
        (t.fn.calendar = function (e) {
            var i,
                s = this.data("calendar"),
                o = [].slice.call(arguments);
            return s
                ? a(e)
                    ? ((i = e), o.shift(), s.methods(i, o))
                    : this
                : this.each(function () {
